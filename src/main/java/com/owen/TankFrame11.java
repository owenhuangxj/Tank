 ...
 *
 * @author OwenHuang
 * @since 2022/11/4 17:25
 */
public class TankFrame11 extends Frame {
    private static final int GAME_WIDTH = 800;
    private static final int GAME_HEIGHT = 800;

    private Image screenImage;
    private TankWithMultiBullets tank = new TankWithMultiBullets(200, 200, Direction.DOWN, this);
